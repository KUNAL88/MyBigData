...
public class AvroDataProducer {
    ...
    public static void main(String[] args) {
        new AvroDataProducer().deserializeData();//.createDataList();
    }
    ...
    private List<Person> createDataList(){
        ...
        try {
            dataFileWriter.create(RawMessage.SCHEMA$,new File("./src/main/resources/rawfile/RawMessage.avro"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        for(int i=1;i<10;i++){
    ...
    public void deserializeData(){
        ...
        try {
            DataFileReader dataFileReader=new DataFileReader(new File("./src/main/resources/rawfile/RawMessage.avro"),datumReader);
